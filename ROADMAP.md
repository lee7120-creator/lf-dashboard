...
**KD(Keyword Difficulty) 점수대 — Semrush 기준**

| KD | 난이도 | 의미 |
|---|---|---|
| 0~14 | 매우 쉬움 | 신규 사이트도 단기 진입 가능 |
| 15~29 | 쉬움 | 기본 최적화로 노려볼 만 |
| 30~49 | 보통 | 양질 콘텐츠 + 약간의 권위 필요 |
| 50~69 | 어려움 | 강한 콘텐츠·백링크 필요 |
| 70~84 | 매우 어려움 | 높은 도메인 권위 필수 |
| 85~100 | 극히 어려움 | 톱 브랜드·대형 포털 영역 |

> 타겟 원칙: **검색량 ↑ · KD ↓** = 황금. KD 50+ 헤드 키워드는 롱테일([CEP]×[카테고리])로 우회해 경쟁을 낮춘다.
